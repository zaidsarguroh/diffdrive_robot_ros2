...
{
public:
  explicit Init_GetTransform_Event_response(::bumperbot_msgs::srv::GetTransform_Event & msg)
  : msg_(msg)
  {}
  ::bumperbot_msgs::srv::GetTransform_Event response(::bumperbot_msgs::srv::GetTransform_Event::_response_type arg)
  {
...
private:
  ::bumperbot_msgs::srv::GetTransform_Event msg_;
};

class Init_GetTransform_Event_request
{
public:
  explicit Init_GetTransform_Event_request(::bumperbot_msgs::srv::GetTransform_Event & msg)
  : msg_(msg)
  {}
  Init_GetTransform_Event_response request(::bumperbot_msgs::srv::GetTransform_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetTransform_Event_request info(::bumperbot_msgs::srv::GetTransform_Event::_info_type arg)
  {
...
template<>
inline
auto build<::bumperbot_msgs::srv::GetTransform_Event>()
{
  return bumperbot_msgs::srv::builder::Init_GetTransform_Event_info();
}
