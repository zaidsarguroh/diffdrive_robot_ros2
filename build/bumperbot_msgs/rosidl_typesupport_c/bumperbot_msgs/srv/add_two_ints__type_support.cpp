...
static const _AddTwoInts_Event_type_support_symbol_names_t _AddTwoInts_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bumperbot_msgs, srv, AddTwoInts_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bumperbot_msgs, srv, AddTwoInts_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bumperbot_msgs, srv, AddTwoInts_Event)() {
  return &::bumperbot_msgs::srv::rosidl_typesupport_c::AddTwoInts_Event_message_type_support_handle;
}
