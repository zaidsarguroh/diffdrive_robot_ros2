...
static const _AddTwoInts_Event_type_support_symbol_names_t _AddTwoInts_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bumperbot_msgs, srv, AddTwoInts_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bumperbot_msgs, srv, AddTwoInts_Event)),
  }
};
...
{
  return &::bumperbot_msgs::srv::rosidl_typesupport_cpp::AddTwoInts_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bumperbot_msgs, srv, AddTwoInts_Event)() {
  return get_message_type_support_handle<bumperbot_msgs::srv::AddTwoInts_Event>();
}
...
static const rosidl_service_type_support_t AddTwoInts_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<bumperbot_msgs::srv::AddTwoInts_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<bumperbot_msgs::srv::AddTwoInts_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<bumperbot_msgs::srv::AddTwoInts_Event>(),
