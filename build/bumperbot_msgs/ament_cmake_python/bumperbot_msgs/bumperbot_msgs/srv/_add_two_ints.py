...
class AddTwoInts_Event(metaclass=Metaclass_AddTwoInts_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<bumperbot_msgs/AddTwoInts_Request, 1>',
        'response': 'sequence<bumperbot_msgs/AddTwoInts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['bumperbot_msgs', 'srv'], 'AddTwoInts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['bumperbot_msgs', 'srv'], 'AddTwoInts_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from bumperbot_msgs.srv import AddTwoInts_Request
    ...
    def response(self, value):
        if self._check_fields:
            from bumperbot_msgs.srv import AddTwoInts_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    ...
    from bumperbot_msgs.srv._add_two_ints import AddTwoInts_Event as Event
