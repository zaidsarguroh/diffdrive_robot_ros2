...
class SimpleTfKinematics(Node):
    def __init__(self):
        ...
        self.get_logger().info("Publishing static transforms between %s and %s" %
        ...
        self.get_tranform_srv = self.create_service(GetTransform, "get_transform", self.getTransformCallback)
